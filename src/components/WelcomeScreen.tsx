...
export default function WelcomeScreen() {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-[99999] flex items-center justify-center bg-[var(--color-paper)] overflow-hidden p-5"
    >
      {/* Background Glow */}
      ...
      >
        ...
        >
          Building AI Systems That Think & Act.
        </motion.p>
